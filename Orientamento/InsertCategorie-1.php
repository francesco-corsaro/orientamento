...
//$stmt->execute();
$sql = "INSERT INTO Prova (Id,$Categoria1, $Categoria3, $Categoria4, $PntCat1, $PntCat2, $PntCat3,$PntCat4)
        VALUES ( '$id','$Categoria1', '$Categoria3', '$Categoria4', '$PntCat1', '$PntCat2', '$PntCat3','$PntCat4')";

if ($conn->query($sql) === TRUE) {
    echo " |Categorie Caricate nel ";
} else {
