...
<body>
<form action="/Orientamento/4categorieoccupazionali.php" method="post"  >
<label>
	
	<input type="checkbox" name="c[]" value="professionali">
	<?php echo $professionali ?><br>

</label><br>
<label>
	
	<input type="checkbox" name="c[]" value="Agricoltura">
	<?php echo $agricoltura ?><br>
	
</label><br>
<label>

	<input type="checkbox" name="c[]" value="trasporti">
		<?php echo $trasporti ?><br>
...
<label>
	...
	<?php echo $segreteria ?><br>
</label><br>
<label>
	
	<input type="checkbox" name="c[]" value="commerciale">
	<?php echo $commerciale ?><br>
</label><br>
<label>
...
<label>
	...
	<?php echo $educazione ?><br>
</label><br>
<label>
	
	<input type="checkbox" name="c[]" value="sciumane">
	<?php echo $sciumane ?><br>
</label><br>
<label>
