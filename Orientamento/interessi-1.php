 ...
 foreach ($interessi as $chiave=>$testo){
     ...
     echo  
        '<div class="col-12 tenda">
            <p class="r">'.$testo.'</p>
            <label class="contenitore" for="usr['.$chiave.']"><br>
                <b class="color">Assolutamente in disaccordo</b> 
                <input id="usr['.$chiave.']" name="punntint['.$chiave.']" type="radio" value="0"/>
                <span class="buttondo"></span>
            </label>
            <label class="contenitore" for="usr['.$chiave.']"><br>
                <b class="color">Leggermente in disaccordo</b> 
                <input  id="usr['.$chiave.']" name="punntint['.$chiave.']" type="radio" value="1"/>
                <span class="buttondo"></span>
            </label>
            <label class="contenitore" for="usr['.$chiave.']"><br>
                <b class="color">D\'accordo</b> 
                <input checked="checked" id="usr['.$chiave.']" name="punntint['.$chiave.']" type="radio" value="2"/>
                <span class="buttondo"></span>
            </label>
            <label class="contenitore" for="usr['.$chiave.']"><br>
                <b class="color">Completamente d\'accordo</b> 
                <input  id="usr['.$chiave.']" name="punntint['.$chiave.']" type="radio" value="3"/>
                <span class="buttondo"></span>
            </label>
          </div>';
